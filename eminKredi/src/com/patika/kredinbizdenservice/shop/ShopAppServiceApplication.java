...
public class ShopAppServiceApplication {
	...
	public static void main(String[] args) {
		...
		//1.Sistemdeki bütün müşterisi sayısını bulan fonksiyon
		...
		//2.İsmi Cem olan müşterilerin aldıkları ürün sayısını bulan fonksiyon
		com.patika.kredinbizdenservice.shop.Consumer.listSpecificUsersBill(list,"Cem");
		//3.İsmi Cem olup yaşı 30’dan küçük 25’ten büyük müşterilerin toplam alışveriş tutarını hesaplayan fonksiyon
		com.patika.kredinbizdenservice.shop.Consumer.listSpecificUserwithAge(list,"Cem");
		//4.Sistemdeki 1500 TL üzerindeki faturaları listeleyen fonksiyon
