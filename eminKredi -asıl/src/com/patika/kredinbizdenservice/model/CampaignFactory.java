...
public class CampaignFactory {
	...
	public Campaign createCampaign(String title, String content, LocalDate dueDate, LocalDate createDate, LocalDate updateDate, SectorType sector,Bank bank) {
        return new Campaign(title,content,dueDate,createDate,updateDate,sector,bank);
    }
	
	
	CampaignFactory campaing=CampaignFactory.getInstance();
